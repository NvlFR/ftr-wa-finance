            ...
            <q-card style="max-width: 600px" class="q-mx-auto">
                <q-form @submit.prevent="submit">
                    <q-card-section class="q-gutter-md">
                        <q-input filled v-model="form.category" label="Nama Kategori" :error="!!form.errors.category" :error-message="form.errors.category" />
                        <q-input filled v-model.number="form.amount" type="number" label="Jumlah Budget (Rp)" :error="!!form.errors.amount" :error-message="form.errors.amount" />
                    </q-card-section>
                    <q-card-actions align="right" class="q-pa-md">
                        <q-btn :href="route('budgets.index')" flat label="Batal" />
