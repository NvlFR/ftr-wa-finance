                ...
                >
                    <q-list id="main-nav">
                        ...
                        <q-item
                            clickable
                            v-ripple
                            :active="$page.url.startsWith('/app/admin/investments')"
                        ...
                        >
                            ...
                            <q-item
                                ...
                                @click="
                                    router.get(
                                        route('recuring-transactions.index')
                                    )
                                "
                            >
                                <q-item-section avatar>
                                ...
                                <q-item-section>
                                    <q-item-label
                                        >Transaksi Berulang</q-item-label
                                    >
                                </q-item-section>
                            </q-item>
                        </q-expansion-item>
                ...
                <q-btn-dropdown flat no-caps>
                    <template v-slot:label>
                        <div class="row items-center no-wrap">
                            ...
                            <div class="text-weight-bold"><slot name="title">{{ page.props.appName }}</slot></div>
                        </div>
                    </template>
